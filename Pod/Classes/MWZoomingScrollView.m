...
- (id)initWithPhotoBrowser:(MWPhotoBrowser *)browser {
    if ((self = [super init])) {
        ...
        _tapView.backgroundColor = [UIColor colorWithWhite:237.0f/255.0f alpha:1.0f];
		...
		_photoImageView.backgroundColor = [UIColor colorWithWhite:237.0f/255.0f alpha:1.0f];;
